...
--
-- SUPERSEDED by 049_bow_offset_default.sql (nullable-with-no-default
-- turned out to be the wrong call — see that file). Left exactly as
-- originally applied to GBSC/IS on 2026-07-29 — do not edit this file
-- again; it no longer matches this repo's HEAD schema on its own.
