-- News feed table — was only ever run ad-hoc from the loose root file
-- gbsc-news-table.sql, never folded into the tracked migration history.
-- Formalizing it here so a fresh database (e.g. RCYC) picks it up.
