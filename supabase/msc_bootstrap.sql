-- ============================================================
-- Mayo Sailing Club Racing App — Full Database Bootstrap
-- ============================================================
-- Filled in for: Mayo Sailing Club (short: MSC, slug: msc,
-- Rosmoney, Westport, Co. Mayo, Clew Bay). See supabase/NEW_CLUB_ONBOARDING.md
-- for the full step-by-step process this file is one part of.
--
-- Run this ONCE, in full, against a fresh Mayo Sailing Club Supabase project's
...
--   sbUrl / sbKey  → CLUB_CONFIG_MSC env var in Netlify (club-config.js)
--
...
CREATE POLICY "marks_insert" ON marks FOR INSERT WITH CHECK (
  -- all-Ireland bounds — covers Rosmoney, Westport, Co. Mayo (Clew Bay) along with every other
...
-- MSC's real nearest tide station and datum offset, then set
